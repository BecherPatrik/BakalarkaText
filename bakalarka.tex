...
\begin{itemize}
\item \kiinlinecode{Java}{!}{Main.java}
\item \kiinlinecode{Java}{!}{WindowController.java}
\item \kiinlinecode{Java}{!}{styles.css}
\item \kiinlinecode{Java}{!}{Window.fxml}
\end{itemize}

\smallskip
\noindent \textbf{Třída Main}\\
...
\noindent \textbf{Třída WindowController}\\
...
\noindent \textbf{Soubor kaskádových stylů styles}\\
...
\noindent \textbf{Soubor FXML Window}\\
...
\noindent \textbf{Seznam tříd v balíku:}
\begin{itemize}
...
\smallskip
\noindent \textbf{Interface ITree} \label{ITree}\\

\noindent \textbf{Interface INode}\\

\noindent \textbf{Třídy BinaryTree, AVLTree, RedBlackTree}\\

\noindent \textbf{Třídy BinaryNode, AVLNode, RedBlackNode}\\

\noindent \textbf{Třída RecordOfAnimation}\\

\noindent \textbf{Třída Result} \label{Result}\\

\noindent \textbf{Enum AnimatedAction}\\

\noindent \textbf{Enum Color}\\

\noindent \textbf{Enum Side}\\
