...
\textit{Binární stromy} jsou typy kořenových stromů, ve kterých každý obsažený uzel má maximálně 2 potomky.
\end{definition}
\smallskip
...
Binární \textit{vyhledávací} strom, je speciální typ binárního stromu, kde platí následující:
\begin{itemize}
