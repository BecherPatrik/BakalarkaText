...
\indent Tato třída obsluhuje všechny prvky okna vytvořené v FXML. Pomocí anotace \textit{@FXML} získá tato třída reference na prvky GUI. Její hlavní činnost spočívá ve vykonávání metod, které jsou  v souboru \kiinlinecode{Java}{!}{Window.fxml} definovány pro prvky okna. Mezi hlavní metody navázané na prvky okna jsou: 
...
//TODO 
Tuto skutečnost využívám např. při pozicování kořenu stromu doprostřed okna. DoubleProperty x kořenu propojím s atributem stageWidthProperty a tím měním pozici celého stromu na základě změny šířky okna. 
