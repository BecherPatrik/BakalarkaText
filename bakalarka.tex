...
\keywords{Binární vyhledávací stromy, Binární strom, AVL strom, Červeno-černý strom, Stromové animace Java, JavaFX}
\keywords[english]{Binary search trees, Binary tree, AVL tree, Red-black tree, Tree animations, Java, JavaFX}
